...
I often used \mintinline{tex}|\setlength{\itemsep}{0pt}\setlength{\parskip}{0pt}| to make itemizes and enumerates tighter,
thus a command \mintinline{tex}{\tightlist} is aliased to it.
...
\begin{Code}{tex}
\begin{spacing}{1}
  % some file from my computer security course
